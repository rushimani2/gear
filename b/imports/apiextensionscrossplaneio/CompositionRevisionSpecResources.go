...
type CompositionRevisionSpecResources struct {
	...
	ConnectionDetails *[]*CompositionRevisionSpecResourcesConnectionDetails `field:"optional" json:"connectionDetails" yaml:"connectionDetails"`
	...
	Patches *[]*CompositionRevisionSpecResourcesPatches `field:"optional" json:"patches" yaml:"patches"`
	...
	ReadinessChecks *[]*CompositionRevisionSpecResourcesReadinessChecks `field:"optional" json:"readinessChecks" yaml:"readinessChecks"`
}
