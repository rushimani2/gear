...
type CompositionSpecPatchSetsPatchesTransformsString struct {
	// Convert the type of conversion to Upper/Lower case.
	Convert CompositionSpecPatchSetsPatchesTransformsStringConvert `field:"optional" json:"convert" yaml:"convert"`
	...
	Regexp *CompositionSpecPatchSetsPatchesTransformsStringRegexp `field:"optional" json:"regexp" yaml:"regexp"`
	// Trim the prefix or suffix from the input.
	Trim *string `field:"optional" json:"trim" yaml:"trim"`
	// Type of the string transform to be run.
	Type CompositionSpecPatchSetsPatchesTransformsStringType `field:"optional" json:"type" yaml:"type"`
}
