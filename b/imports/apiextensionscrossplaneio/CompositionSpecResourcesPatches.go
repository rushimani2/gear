...
type CompositionSpecResourcesPatches struct {
	// Combine is the patch configuration for a CombineFromComposite or CombineToComposite patch.
	Combine *CompositionSpecResourcesPatchesCombine `field:"optional" json:"combine" yaml:"combine"`
	...
	Policy *CompositionSpecResourcesPatchesPolicy `field:"optional" json:"policy" yaml:"policy"`
	...
	Transforms *[]*CompositionSpecResourcesPatchesTransforms `field:"optional" json:"transforms" yaml:"transforms"`
	// Type sets the patching behaviour to be used.
	//
	// Each patch type may require its' own fields to be set on the Patch object.
	Type CompositionSpecResourcesPatchesType `field:"optional" json:"type" yaml:"type"`
}
