...
type CompositionSpecResourcesPatchesTransformsString struct {
	// Convert the type of conversion to Upper/Lower case.
	Convert CompositionSpecResourcesPatchesTransformsStringConvert `field:"optional" json:"convert" yaml:"convert"`
	...
	Regexp *CompositionSpecResourcesPatchesTransformsStringRegexp `field:"optional" json:"regexp" yaml:"regexp"`
	// Trim the prefix or suffix from the input.
	Trim *string `field:"optional" json:"trim" yaml:"trim"`
	// Type of the string transform to be run.
	Type CompositionSpecResourcesPatchesTransformsStringType `field:"optional" json:"type" yaml:"type"`
}
