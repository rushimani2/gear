...
type CompositionRevisionSpecPatchSetsPatches struct {
	// Combine is the patch configuration for a CombineFromComposite or CombineToComposite patch.
	Combine *CompositionRevisionSpecPatchSetsPatchesCombine `field:"optional" json:"combine" yaml:"combine"`
	...
	Policy *CompositionRevisionSpecPatchSetsPatchesPolicy `field:"optional" json:"policy" yaml:"policy"`
	...
	Transforms *[]*CompositionRevisionSpecPatchSetsPatchesTransforms `field:"optional" json:"transforms" yaml:"transforms"`
	// Type sets the patching behaviour to be used.
	//
	// Each patch type may require its' own fields to be set on the Patch object.
	Type CompositionRevisionSpecPatchSetsPatchesType `field:"optional" json:"type" yaml:"type"`
}
